...
export default function Home() {
  ...
  return (
    ...
    <Services />
    <Gallery />
    <div className="flex flex-col justify-center items-center m-auto md:h-[540px] md:flex-row  gap-5">
      <div >
        <img height={900} width={900} src="https://images.unsplash.com/photo-1548199973-03cce0bbc87b?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8ZG9nc3xlbnwwfHwwfHx8MA%3D%3D" alt="png" />
      </div>
      <div>
